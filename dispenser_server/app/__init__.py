...
def create_everything(db):
    ...
    if(len(Home.query.all()) == 0 ):
        ...
        food = Food_Item(name = "food item7  ", quantity = 45, category = "dengue ", wish_list = wishlist1)
        food = Food_Item(name = "food item8  ", quantity = 1, category = " congelado " ,wish_list = wishlist1)
        ...
        food = Food_Item(name = "food item15 ", quantity = 3, category = "frios ", wish_list = wishlist3)
        food = Food_Item(name = "food item16 ", quantity = 55, category = "quentes  ", wish_list = wishlist3)
        food = Food_Item(name = "food item17 ", quantity = 3, category = " dengues ", wish_list = wishlist4)
