...
class AddProductInventoryPage extends StatefulWidget {
  AddProductInventoryPage({Key key}) : super(key: key);
...
class _AddProductState extends State<AddProductInventoryPage> {
